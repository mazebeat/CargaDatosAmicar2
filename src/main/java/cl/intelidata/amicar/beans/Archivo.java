...
public class Archivo {
	 ...
	 * lista con los datos
	 *
	 * @param strArchivo  nombre del archivo a leer
	 * @param strCabecera cabecera o primera linea a insertar
	 *
	...
	public List<String> leer(String strArchivo, String strCabecera) {
		...
		try {
			...
			FastFileTextReader fastFileTextReader = new FastFileTextReader(
					this.getStrPathEntrada() + strArchivo.trim(), FastFileTextReader.ISO_8859_1, 1024 * 40
			);
			/********************************************************************/
			...
			System.out.println(
					"El archivo " + strArchivo + " no fue encontrado"
			);
			System.exit(1);
		} catch (Exception e) {
	...
	public void guardarLista(List<String> lista, String strRuta, String strCabecera, String strExtension) {
		...
		try {
			...
			MessageUtils.info("Creando el archivo " + strArchivo);
			if (strCabecera != null) {
			...
			MessageUtils.info("Escribiendo los datos...");
			for (String strDatos : lista) {
				bufferedWriter.append(strDatos);
				bufferedWriter.newLine();
			}
			bufferedWriterArchivo = new BufferedWriter(
					new OutputStreamWriter(
	...
	public void guardarListaCSV(List<String> lista, String strNombreArchivo, String strCabecera) {
		...
		try {
			...
			if (strCabecera != null) {
				// Inserta la cabecera del archivo
				MessageUtils.info("Insertando Cabecera...");
				bufferedWriter.append(strCabecera);
				bufferedWriter.newLine();
			}
			// Lee la lista y escribe el archivo
	 ...
	 *
	 * @param strDirectorioEntrada Ruta donde se alojan los archivos
	 */
	private void setPath(String strDirectorioEntrada, String strDirectorioSalida) {

		MessageUtils.info("Seteando los directorios de entrada y salida...");

		setStrPathEntrada(strDirectorioEntrada);
		setStrPathSalida(strDirectorioSalida);

		MessageUtils.info("Directorios verificados y listo para la indexacion...");
	}
