...
/**
 	* A data access object (DAO) providing persistence and search support for Proceso entities.
...
public class ProcesoDAO  implements IProcesoDAO{
    ...
    public void delete(Proceso entity) {
	        ...
	        try {
        	entity = getEntityManager().getReference(Proceso.class, entity.getIdProceso());
    ...
    public Proceso findById( Integer id) {
    				EntityManagerHelper.log("finding Proceso instance with id: " + id, Level.INFO, null);
	        try {
...
/**
    ...
    public List<Proceso> findByProperty(String propertyName, final Object value
        , final int...rowStartIdxAndCount
        ) {
    				EntityManagerHelper.log("finding Proceso instance with property: " + propertyName + ", value: " + value, Level.INFO, null);
			try {
	...
	public List<Proceso> findAll(
		final int...rowStartIdxAndCount
					...
					EntityManagerHelper.log("finding all Proceso instances", Level.INFO, null);
			try {
