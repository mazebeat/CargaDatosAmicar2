...
public interface IClientealgoritmoDAO {
	 ...
	 * </pre>
	   @param entity Clientealgoritmo entity to persist
	  @throws RuntimeException when the operation fails
	 */
    public void save(Clientealgoritmo entity);
    /**
	 Delete a persistent Clientealgoritmo entity.
	 ...
	 *   entity = null;
	 * </pre>
	   @param entity Clientealgoritmo entity to delete
	 @throws RuntimeException when the operation fails
	 */
    public void delete(Clientealgoritmo entity);
   /**
	 Persist a previously saved Clientealgoritmo entity and return it or a copy of it to the sender. 
	 A copy of the Clientealgoritmo entity parameter is returned when the JPA persistence mechanism has not previously been tracking the updated entity. 
	 ...
	 *   EntityManagerHelper.commit();
	 * </pre>
	   @param entity Clientealgoritmo entity to update
	 @return Clientealgoritmo the persisted Clientealgoritmo entity instance, may not be the same
	 ...
	 * Find all Clientealgoritmo entities with a specific property value.  
	  ...
	  @param propertyName the name of the Clientealgoritmo property to query
	  @param value the property value to match
	  	  @param rowStartIdxAndCount Optional int varargs. rowStartIdxAndCount[0] specifies the  the row index in the query result-set to begin collecting the results. rowStartIdxAndCount[1] specifies the the maximum count of results to return.  
	  	  @return List<Clientealgoritmo> found by query
	 */
	public List<Clientealgoritmo> findByProperty(String propertyName, Object value
	 ...
	 */
	public List<Clientealgoritmo> findAll(
			int...rowStartIdxAndCount
		);	
}