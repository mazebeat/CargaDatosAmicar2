...
/**
 	* A data access object (DAO) providing persistence and search support for Ejecutivos entities.
...
public class EjecutivosDAO  implements IEjecutivosDAO{
    ...
    public void delete(Ejecutivos entity) {
    				EntityManagerHelper.log("deleting Ejecutivos instance", Level.INFO, null);
	        try {
        	entity = getEntityManager().getReference(Ejecutivos.class, entity.getIdEjecutivo());
    ...
    public Ejecutivos update(Ejecutivos entity) {
    				EntityManagerHelper.log("updating Ejecutivos instance", Level.INFO, null);
	        try {
    ...
    public Ejecutivos findById( Integer id) {
    				EntityManagerHelper.log("finding Ejecutivos instance with id: " + id, Level.INFO, null);
	        try {
...
/**
    ...
    public List<Ejecutivos> findByProperty(String propertyName, final Object value
        , final int...rowStartIdxAndCount
        ) {
    				EntityManagerHelper.log("finding Ejecutivos instance with property: " + propertyName + ", value: " + value, Level.INFO, null);
			try {
	...
	public List<Ejecutivos> findAll(
		final int...rowStartIdxAndCount
					...
					EntityManagerHelper.log("finding all Ejecutivos instances", Level.INFO, null);
			try {
