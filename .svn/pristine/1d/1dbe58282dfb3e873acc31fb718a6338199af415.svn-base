...
public interface IVendedoresDAO {
		/**
	 Perform an initial save of a previously unsaved Vendedores entity. 
	 ...
	 * </pre>
	   @param entity Vendedores entity to persist
	  @throws RuntimeException when the operation fails
	 */
    public void save(Vendedores entity);
    /**
	 Delete a persistent Vendedores entity.
	 ...
	 *   entity = null;
	 * </pre>
	   @param entity Vendedores entity to delete
	 @throws RuntimeException when the operation fails
	 */
    public void delete(Vendedores entity);
   /**
	 Persist a previously saved Vendedores entity and return it or a copy of it to the sender. 
	 A copy of the Vendedores entity parameter is returned when the JPA persistence mechanism has not previously been tracking the updated entity. 
	 ...
	 *   EntityManagerHelper.commit();
	 * </pre>
	   @param entity Vendedores entity to update
	 @return Vendedores the persisted Vendedores entity instance, may not be the same
	 ...
	 * Find all Vendedores entities with a specific property value.  
	  ...
	  @param propertyName the name of the Vendedores property to query
