...
public interface IClientesDAO {
		/**
	 Perform an initial save of a previously unsaved Clientes entity. 
	 ...
	 * </pre>
	   @param entity Clientes entity to persist
	  @throws RuntimeException when the operation fails
	 */
    public void save(Clientes entity);
    /**
	 Delete a persistent Clientes entity.
	 ...
	 *   entity = null;
	 * </pre>
	   @param entity Clientes entity to delete
	 @throws RuntimeException when the operation fails
	 */
    public void delete(Clientes entity);
   /**
	 Persist a previously saved Clientes entity and return it or a copy of it to the sender. 
	 A copy of the Clientes entity parameter is returned when the JPA persistence mechanism has not previously been tracking the updated entity. 
	 ...
	 *   EntityManagerHelper.commit();
	 * </pre>
	   @param entity Clientes entity to update
	 @return Clientes the persisted Clientes entity instance, may not be the same
	 ...
	 * Find all Clientes entities with a specific property value.  
	  ...
	  @param propertyName the name of the Clientes property to query
